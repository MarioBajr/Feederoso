package puremvc.service
{
    ...
    {
        private static const SOURCE:String =  'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)';
...
//                  writeSO(gvo);
        ...
        {
			var headers:Array = new Array(new URLRequestHeader("Authorization", "GoogleLogin auth="+_AUTH));
            return headers;
        }
